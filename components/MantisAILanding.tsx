    ...
    <div className="bg-w-bg-secondary border-b border-w-border">
      <div className="mx-auto flex max-w-7xl items-center justify-center gap-3 px-4 py-2.5">
        <span className="text-[13px] text-w-text">
          ...
          {" "}- Smart inventory and pricing for small businesses
        </span>
        <a
          href="#cta"
...
function RotatingPills({ reducedMotion }: { reducedMotion: boolean }) {
  const items = ["Predictive Inventory", "Smart Pricing", "Private Data", "Human Approval"];
...
function HeroTerminal({ reducedMotion }: { reducedMotion: boolean }) {
  const exchanges = useMemo(
    () => [
      { q: "mantis status --today", a: "Live. Yesterday: spoilage down 23%, margins up 4.1%. 3,847 transactions synced. Zero data left the building." },
      { q: "What should I order for tomorrow?", a: "Based on weather + footfall patterns: increase fast-movers by 8 units, run a 15% flash discount on overstock. Strategy ready for your approval." },
      { q: "Show me today's approval queue.", a: "3 recommendations waiting: (1) discount overstock by 15%, (2) reorder fast-movers +8 units, (3) flash promo on short-dated stock. One-click to approve." },
    ],
    []
  );
  ...
  return (
    <div className="overflow-hidden rounded-xl border border-w-border bg-w-bg-secondary shadow-[0_32px_80px_-20px_rgba(0,0,0,0.65)]">
      ...
      <div className="grid grid-cols-3 divide-x divide-w-border border-t border-w-border">
        {[
          { label: "Transactions synced", value: "2,847/hr" },
          { label: "Scenarios tested", value: "12k" },
          { label: "Data kept local", value: "100%" },
        ].map((m) => (
    ...
    <section className="relative mx-auto max-w-7xl px-6 pb-24 pt-20 sm:pt-28">
      ...
      <div className="relative mx-auto max-w-4xl text-center">
        ...
        <span className="inline-flex items-center gap-2 rounded-full border border-white/25 bg-white/10 px-3.5 py-1 text-[12px] font-medium text-white">
            ...
            Predictive · Private · Human-Approved
          </span>
        </motion.div>
        ...
        >
          Mantis AI predicts exactly what your business needs to order, price, and sell before waste
          happens. It plugs into your existing till, protects your private data, and runs your daily
          inventory on autopilot so you can focus on growing your business.
        </motion.p>
      ...
      <div className="grid items-center gap-16 lg:grid-cols-2">
        ...
        >
          ...
          <p className="mt-4 text-[16px] leading-relaxed text-w-text">
            Mantis replaces your messy spreadsheets and outdated forecasts with a simple,
            secure system that tells you exactly what to order, price, and sell before
            waste happens.
          </p>
        ...
        >
          {[
            { icon: Cpu, title: "Slow Manual Work → Instant Setup", desc: "Ditch the messy spreadsheets and clunky software. Mantis lives on a small, secure Apple Mac Mini right in your back office. It automatically organizes your daily sales data without slowing down your internet." },
            { icon: Brain, title: "Guessing → Knowing", desc: "Traditional forecasting just looks at last month's sales. Mantis acts like a digital manager. It looks at local weather, upcoming events, and your exact customer habits to tell you exactly what will sell tomorrow." },
            { icon: Eye, title: "Losing Control → Full Transparency", desc: "Never hand the keys over to a black box. Mantis gives you recommendations, but it never changes a price or orders stock without your clear, one-click approval. You are always in control." },
          ].map((card) => (
...
function CapabilitiesSection({ reducedMotion }: { reducedMotion: boolean }) {
  const products = [
    ...
    },
    {
      ...
      icon: Brain,
      desc: "Mantis learns your specific business patterns. Every night, it calculates exactly how to reduce your spoilage and boost your daily margins.",
    ...
    },
    {
      ...
      icon: Shield,
      desc: "You get the intelligence of thousands of businesses working together, without ever sharing your actual sales numbers. Our system shares only anonymous, encrypted trends to make your local predictions sharper.",
  ...
  return (
    <section id="products" className="mx-auto max-w-7xl px-6 py-28">
      ...
      <div className="mx-auto max-w-3xl text-center">
        ...
        <p className="mt-4 text-[16px] leading-relaxed text-w-text">
          Mantis connects to what you have, learns your business overnight, and taps
          into collective intelligence, all while keeping your data completely private.
        </p>
      </div>
      ...
      <div className="mx-auto mt-10 flex flex-wrap items-center justify-center gap-3">
        {[
          { label: "What you need", val: "1", tag: "Mac Mini" },
          { label: "When it runs", val: "6 AM", tag: "Daily strategy" },
          { label: "Your data", val: "100%", tag: "Stays private" },
        ].map((m) => (
...
function WorkflowStepsSection({ reducedMotion }: { reducedMotion: boolean }) {
  ...
  const steps = [
    {
      num: "1",
      title: "Plug in the Mantis Local Node",
      headline: "Deploy the Node. Secure the Data.",
      desc: "We send you a pre-configured smart hub. You plug it in, and it securely connects to your existing point-of-sale and inventory systems. It cleans up your messy data automatically. Best of all? Your sensitive customer and sales data never leaves your building. It stays entirely private.",
      icon: Cpu,
      tags: ["Mac Mini HaaS", "Rust Ingestor", "DuckDB", "Local Storage"],
    },
    {
      num: "2",
      title: "Synthesize your Environment",
      headline: "Map the Reality. Simulate the Future.",
      desc: "To keep your systems running fast during the day, Mantis does its heavy lifting while you sleep. Overnight, it runs thousands of what-if scenarios, like how a sudden rainstorm tomorrow will affect your foot traffic, to figure out the perfect pricing and stock strategy for the next morning.",
      icon: Link2,
      tags: ["Met Office Weather", "DEFRA Metrics", "Knowledge Graph", "Signal Fusion"],
    },
    {
      num: "3",
      title: "Review & Execute",
      headline: "Review the Logic. Automate the Execution.",
      desc: "By 6:00 AM, your daily strategy is ready. You review a simple dashboard showing what to discount and what to order. If it looks good, just hit approve. Mantis will automatically update your digital prices and send the orders to your suppliers.",
      icon: Shield,
      tags: ["Overnight Swarm", "6 AM Convergence", "HITL Governance", "Audit Trail"],
    },
  ];
  ...
  return (
    <section id="how" className="mx-auto max-w-7xl px-6 py-28">
      ...
      <div className="mx-auto max-w-3xl text-center">
        ...
        <p className="mt-4 text-[16px] leading-relaxed text-w-text">
          Plug it in, sleep peacefully, and start your day with a clear plan.
        </p>
      </div>
    ...
    <section className="mx-auto max-w-7xl px-6 py-28">
      ...
      >
        ...
        <div className="relative">
            ...
            &ldquo;Mantis doesn&apos;t just forecast - it simulates. The overnight swarm model cut our spoilage by 23%
              and lifted margins by 4.1% in the first month. The HITL approval gate means I never worry about rogue automated pricing.&rdquo;
            </p>
            <div className="mt-8 flex items-center gap-3">
              <div className="h-10 w-10 rounded-full border border-w-border bg-w-card" />
              <div>
                <div className="text-[14px] font-semibold text-w-cream">Head of Operations</div>
                <div className="text-[12px] text-w-muted">Independent Retail Group</div>
              </div>
            </div>
          </div>
        </div>
...
function LifecycleSection({ reducedMotion }: { reducedMotion: boolean }) {
  ...
  const tabs = [
    { label: "Connect", icon: Cpu,
      ...
      features: [
        "Connects to any point-of-sale or inventory system you already own",
        "Automatically cleans and organizes fragmented data",
        "Runs entirely on a Mac Mini in your back office. No internet needed",
        "Your sales data never leaves your building",
      ] },
      ...
      <div className="relative overflow-hidden rounded-xl border border-w-border bg-w-bg-secondary">
        ...
        <div className="grid gap-10 p-8 sm:p-12 lg:grid-cols-[1.2fr_0.8fr] lg:items-center lg:p-14">
          <div>
            ...
            <p className="mt-3 max-w-xl text-[15px] leading-relaxed text-w-text">
              We&apos;re onboarding businesses across every sector. Plug in your Mac Mini,
              connect your existing systems, and start eliminating waste with smart, simple intelligence.
            </p>
          </div>
        ...
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-[1.5fr_1fr_1fr_1fr_1fr]">
          <div>
            ...
            <p className="mt-3 max-w-xs text-[13px] leading-relaxed text-w-muted">
              Powerful, private, and built to protect the razor-thin margins of independent
              businesses. Smart inventory management, right in your back office.
            </p>
          </div>
          {columns.map((col) => (
            <div key={col.title}>
